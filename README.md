...
| `/lminaudier:mikado` | Drive large-scale code changes using the Mikado Method — try, fail, record prerequisites as a dependency graph, revert, resolve leaves first, and visualize progress as an Excalidraw diagram. |
